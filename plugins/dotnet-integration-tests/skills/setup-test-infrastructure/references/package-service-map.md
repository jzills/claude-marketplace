...
Match package names using contains matching against the **Package Pattern** column.
...
| `Confluent.Kafka` | Kafka | `confluentinc/cp-kafka:7.6.1` | `Testcontainers.Kafka` | `KafkaBuilder` |
| `MassTransit.Kafka` | Kafka | `confluentinc/cp-kafka:7.6.1` | `Testcontainers.Kafka` | `KafkaBuilder` |
